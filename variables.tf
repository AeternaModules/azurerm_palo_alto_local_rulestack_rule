...
EOT
  ...
  type = map(object({
    ...
    decryption_rule_type      = optional(string) # Default: "None"
    description               = optional(string)
    enabled                   = optional(bool) # Default: true
    inspection_certificate_id = optional(string)
    logging_enabled           = optional(bool) # Default: false
    negate_destination        = optional(bool) # Default: false
    negate_source             = optional(bool) # Default: false
